...
(custom-set-variables
 ...
 ;; '(org-agenda-files '("~/org/core.org" "~/org/school.org"))
...
(defun git-config-init ()
  ...
  (interactive)
  (shell-command "git config --global user.email \"d_korytov@apple.com\"")
  ...
  (shell-command "git config --global init.defaultBranch main")
